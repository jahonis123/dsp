...
I installed Python 3, with the main reason being that Python 3 has the latest packages, integrations, etc. Additionally, the above suggests that Python 3 is the recommended version based on configuration.
